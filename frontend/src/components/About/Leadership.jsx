...
import seniorPastorImg from '../../assets/leadership/johnSmith.jpeg';
import leadPastorImg from '../../assets/leadership/leadPastor.jpeg';

import leader1 from '../../assets/leadership/janeDoe.jpeg';
import leader2 from '../../assets/leadership/johnSmith.jpeg';
import leader3 from '../../assets/leadership/emilyJohnson.jpeg';
import leader4 from '../../assets/leadership/michaelBrown.jpeg';
import leader5 from '../../assets/leadership/sarahLee.jpeg';
import leader6 from '../../assets/leadership/davidWilson.jpeg';
import leader7 from '../../assets/leadership/lindaDavis.jpeg';
import leader8 from '../../assets/leadership/jamesMiller.jpeg';

// Kenyan style names and titles
const otherLeaders = [
  { id: 1, name: 'Wanjiku Mwangi', title: 'Worship Director', img: leader1 },
...
function Leadership() {
  ...
  Under his leadership, the church has launched various ministries, including outreach
  ...
  organizing impactful evangelistic events.

  Known for her nurturing spirit and wisdom, Pastor Njeri also leads intercessory prayer
  teams and provides pastoral care to families and individuals. Through her tireless
